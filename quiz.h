...
/* Given a chord in the key of C, generate a ChordQItem of that chord transposed
   to a random key, and put somewhere in the range of midi notes
   [min_mn, max_mn). The name of the QItem will be generated by a given suffix
   appended to the key name. If show_lowest is true, then the value of the
   lowest note will be appended to this name.*/
